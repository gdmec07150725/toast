package cn.edu.gdmec.s07150725.toast;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void b1(View v){
        Toast.makeText(this, "hahahaha,我早就知道", Toast.LENGTH_SHORT).show();
    ...
    public  void b3(View v){
        Toast toast=Toast.makeText(this,"我是一个小黄人-图文显示",Toast.LENGTH_LONG);
